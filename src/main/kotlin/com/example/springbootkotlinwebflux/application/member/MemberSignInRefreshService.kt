...
class MemberSignInRefreshService(
    ...
    override suspend fun refreshSignIn(command: MemberSignInRefreshCommand.RefreshSignIn): AuthToken {
        try {
            ...
            memberRepository.findTopByIdAndDeletedAtIsNull(authToken.memberId)
            ...
            // 새로운 토큰 생성
            val newAccessToken =
                authenticationTokenManager.createToken(authToken.memberId, AuthenticationTokenType.ACCESS)
            val newRefreshToken =
                authenticationTokenManager.createToken(authToken.memberId, AuthenticationTokenType.REFRESH)
